          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="bg-white rounded-full p-1 flex items-center justify-center">
                <img src={logo} alt="PROTECT EPI" className="h-32 w-32 object-contain" />
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map(link => <li key={link.id}>
                  <button onClick={() => scrollToSection(link.id)} className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors duration-200">
                    {link.label}
                  </button>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+5517996777841" className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors duration-200">
                  (17) 99677-7841
                </a>
              </li>
              <li className="flex items-start gap-2">
                <Mail className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                <a href="mailto:comercial.protectepi@gmail.com" className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors duration-200 break-all">
